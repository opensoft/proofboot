...
if (PROOF_ADD_CODE_COVERAGE AND NOT ANDROID)
    list(FIND CMAKE_CXX_FLAGS "--coverage" PROOF_CODE_COVERAGE_ADDED)
    if (${PROOF_CODE_COVERAGE_ADDED} EQUAL -1)
        message("-- Proof: Building with gcov support")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -g -O0 --coverage -fno-inline -fno-inline-small-functions -fno-default-inline -fkeep-static-functions -fno-elide-constructors")
...
function(proof_add_module target)
    ...
    if (((PROOF_FULL_BUILD AND PROOF_CI_BUILD) OR PROOF_DEV_BUILD OR ANDROID) AND _arg_HAS_QML)
