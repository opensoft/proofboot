...
echo "$ tar -czf package-$TARGET_NAME.tar.gz package-$TARGET_NAME && mv package-$TARGET_NAME.tar.gz build/";
docker exec -t builder bash -c "tar -czf package-$TARGET_NAME.tar.gz package-$TARGET_NAME && mv package-$TARGET_NAME.tar.gz build/";
